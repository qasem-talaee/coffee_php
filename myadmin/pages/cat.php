    ...
    <div class="row purchace-popup text-center">
        <div class="col-12 stretch-card grid-margin text-center">
            <div class="card card-secondary text-center">
                ...
                <p class="mb-lg-0 text-center">دسته بندی ها</p>
                </span>
            </div>
        </div>
    </div>
...
<div style="direction:rtl;">
    <div class="row purchace-popup text-center">
        <div class="col-12 stretch-card grid-margin text-center">
            <div class="card card-secondary text-center">
                <span class="card-body d-lg-flex align-items-center text-center">
                <a class="mb-lg-0 text-center btn btn-primary" href="?add_cat">اضافه کردن دسته بندی جدید</a>
                </span>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-sm-flex align-items-center mb-4">
                    <h4 class="card-title mb-sm-0">دسته بندی ها</h4>
                </div>
                    ...
                    <table class="table text-right">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-primary" href="?edit_cat&id=<?php echo($id); ?>">ویرایش</a></td>
                                <td><?php echo($name); ?></td>
                            </tr>
                            <?php
                            }
